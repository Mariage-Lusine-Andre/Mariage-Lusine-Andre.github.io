const i18n = {
  ...
  hy: {
    ...
    rsvp_deadline: "Մենք շատ ուրախ կլինենք Ձեզ տեսնել մեր հարսանիքին․ խնդրում ենք հաստատել Ձեր ներկայությունը մինչև 12 ապրիլի 2026 թվականը՝ լրացնելով ստորև ներկայացված ձևաթուղթը։ 💍",
...
function setLang(lang) {
  ...
  document.querySelectorAll("[data-i18n]").forEach(el => {
    ...
    if (typeof val === "string") {
      el.innerHTML = val; // ← changement ici
    }
  });
